...
<details>
  <summary>Результат ffuf ☕</summary>

  <pre><code class="language-bash">ffuf -u http://target/FUZZ -w wordlists/common.txt -fs 669
...
<details>
  <summary>ffuf сканирование</summary>
  <pre><code class="bash">
ffuf -u http://target/FUZZ -w wordlists/common.txt -fs 669
